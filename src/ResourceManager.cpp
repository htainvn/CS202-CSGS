...
void ResourceManager::init(std::string theme)
{
    ...
    //Lost screen
    load_texture("LOST_SCREEN", WORKING_DIR + "/src_design/background/" + theme + LOST_BACKGROUND);
    load_texture("HEADSTONE", WORKING_DIR + "/src_design/background/" + theme + HEADSTONE);
    load_texture("BLACKBOARD", WORKING_DIR + "/src_design/background/" + theme + BlackBoard);
