...
void LoadMenuState::update(float dt) {
    ...
    for (int i = 0; i < btt_size; i++) {
        ...
        btt[i].setString("Data " + std::to_string(i));
    ...
    btt[MenuState::buttonSelected].setFillColor(MenuState::button_color[MenuState::buttonSelected]);
        ...
        case (sf::Event::KeyPressed):
            switch (key_event.key.code) {
                ...
                case (sf::Keyboard::Enter):
                    MenuState::tools->state_manager.receive_add_request(new GameLoadedState(MenuState::tools, MenuState::buttonSelected));
                    break;
                default:
                    break;
            }
